...
func TestFromScale(t *testing.T) {
	test.Assert(t, FromScale(5, 0, 10), 0.5)
}

func TestToScale(t *testing.T) {
	test.Assert(t, ToScale(500, 0, 10), 10.0)
	test.Assert(t, ToScale(-1, 0, 10), 0.0)
	test.Assert(t, ToScale(0.5, 0, 10), 5.0)
}

func TestRescale(t *testing.T) {
	test.Assert(t, Rescale(500, 0, 1000, 0, 10), 5.0)
	test.Assert(t, Rescale(-1.0, -1, 0, 490, 350), 490.0)
}
...
func TestDefaultName(t *testing.T) {
	...
	test.Assert(t, strings.Contains(name, "tester"), true)
}
